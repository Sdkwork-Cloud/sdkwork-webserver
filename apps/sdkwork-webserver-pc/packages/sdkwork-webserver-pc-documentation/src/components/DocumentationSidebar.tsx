...
export function DocumentationSidebar({ t }: { t: DocumentationTranslator }) {
  return (
    <aside className="sticky top-[52px] z-30 min-w-0 bg-white shadow-[0_1px_0_rgba(24,24,27,0.08)] dark:bg-[#0d1511] dark:shadow-[0_1px_0_rgba(255,255,255,0.08)] lg:h-[calc(100dvh-52px)] lg:shadow-[1px_0_0_rgba(24,24,27,0.08)] lg:dark:shadow-[1px_0_0_rgba(255,255,255,0.08)]">
