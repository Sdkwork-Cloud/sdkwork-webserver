...
export interface RuntimeRuntimeAssignmentsCurrentRetrieveParams {
  environment: RuntimeEnvironment;
  ifGeneration?: GenerationString;
  ifSnapshotSha256?: Sha256;
}

export class RuntimeRuntimeAssignmentsCurrentApi {
  private client: HttpClient;
...
export class RuntimeRuntimeAssignmentsApi {
  ...
  public readonly observations: RuntimeRuntimeAssignmentsObservationsApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.current = new RuntimeRuntimeAssignmentsCurrentApi(client);
    this.observations = new RuntimeRuntimeAssignmentsObservationsApi(client);
  }
