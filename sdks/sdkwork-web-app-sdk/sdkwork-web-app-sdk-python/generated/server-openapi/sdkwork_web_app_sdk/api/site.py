...
class SiteApi:
    ...
    def create(self, body: CreateSiteRequest, idempotency_key: str) -> SitesCreateResponse201:
        """创建站点"""
        ...
        return self._client.post(f"/app/v3/api/sites", json=body, headers=request_headers)
