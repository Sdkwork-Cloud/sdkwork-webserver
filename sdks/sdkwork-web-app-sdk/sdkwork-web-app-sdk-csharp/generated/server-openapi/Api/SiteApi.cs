...
namespace SDKWork.Web.AppSdk.Api
{
    public class SiteApi
    {
        ...
        public SiteApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// 创建站点
        /// </summary>
        public async Task<SDKWork.Web.AppSdk.Models.SitesCreateResponse201?> SitesCreateAsync(SDKWork.Web.AppSdk.Models.CreateSiteRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<SDKWork.Web.AppSdk.Models.SitesCreateResponse201>(ApiPaths.AppPath("/sites"), body, null, requestHeaders, "application/json");
        }
        ...
        /// 删除站点
        /// </summary>
        public async Task SitesDeleteAsync(string siteId)
        {
            await _client.DeleteAsync<object>(ApiPaths.AppPath($"/sites/{SerializePathParameter(siteId, new PathParameterSpec("siteId", "simple", false))}"));
        }
