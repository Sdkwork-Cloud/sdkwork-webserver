...
use crate::models::{CreateDeploymentRequest, DeploymentResponse};
...
impl DeploymentApi {
    ...
    /// 发起部署
    pub async fn sites_deployments_create(&self, site_id: &str, body: &CreateDeploymentRequest) -> Result<DeploymentResponse, SdkworkError> {
    ...
    /// 回滚部署
    pub async fn sites_deployments_rollback(&self, site_id: &str, deployment_id: &str) -> Result<DeploymentResponse, SdkworkError> {
