...
use crate::models::{CreateDomainRequest, DomainResponse, DomainVerifyResponse};
...
impl DomainApi {
    ...
    /// 绑定域名
    pub async fn sites_domains_create(&self, site_id: &str, body: &CreateDomainRequest) -> Result<DomainResponse, SdkworkError> {
    ...
    /// 验证域名所有权
    pub async fn sites_domains_verify(&self, site_id: &str, domain_id: &str) -> Result<DomainVerifyResponse, SdkworkError> {
