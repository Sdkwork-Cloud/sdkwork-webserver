...
use crate::models::{CreateSourceVersionRequest, ImportGitSourceVersionRequest, SourceVersionResponse};

#[derive(Clone)]
pub struct SourceVersionApi {
    client: Arc<SdkworkHttpClient>,
}

impl SourceVersionApi {
    pub fn new(client: Arc<SdkworkHttpClient>) -> Self {
        Self { client }
    }

    /// 获取应用源码版本
    pub async fn sites_source_versions_list(&self, site_id: &str, page: Option<i64>, page_size: Option<i64>) -> Result<serde_json::Value, SdkworkError> {
