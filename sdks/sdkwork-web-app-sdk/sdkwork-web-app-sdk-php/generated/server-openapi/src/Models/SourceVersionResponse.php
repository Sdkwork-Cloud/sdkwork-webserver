...
use SDKWork\Web\AppSdk\Models\SourceVersionConfigSnapshot;

final class SourceVersionResponse
{
    ...
    public ?SourceVersionConfigSnapshot $configSnapshot = null;
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->configSnapshot = array_key_exists('configSnapshot', $data)
            ? is_array($data['configSnapshot']) ? SourceVersionConfigSnapshot::fromArray($data['configSnapshot']) : null
            : null;
    ...
    public function toArray(): array
    {
        return [
            ...
            'configSnapshot' => $this->configSnapshot instanceof SourceVersionConfigSnapshot ? $this->configSnapshot->toArray() : $this->configSnapshot,
            'status' => $this->status,
