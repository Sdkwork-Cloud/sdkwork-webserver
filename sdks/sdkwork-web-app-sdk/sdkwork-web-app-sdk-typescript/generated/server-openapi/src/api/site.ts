...
/** 创建站点 */
  async create(body: CreateSiteRequest, params: SiteCreateParams, requestOptions?: ApiRequestOptions): Promise<SiteResponse> {
    ...
    return this.client.request<SiteResponse>(appApiPath(`/sites`), { signal: requestOptions?.signal, timeout: requestOptions?.timeout, method: 'POST' as any, body, headers: requestHeaders, contentType: 'application/json' });
  }
