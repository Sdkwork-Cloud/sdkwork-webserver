...
type SourceVersionApi struct {
    client *sdkhttp.Client
}

func NewSourceVersionApi(client *sdkhttp.Client) *SourceVersionApi {
    return &SourceVersionApi{client: client}
}

// 获取应用源码版本
func (a *SourceVersionApi) SitesSourceVersionsList(siteId string, page *int, pageSize *int) (sdktypes.SitesSourceVersionsListResponse, error) {
