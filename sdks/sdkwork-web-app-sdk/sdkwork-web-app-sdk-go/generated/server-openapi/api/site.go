...
import (
    ...
    "net/url"
    "strings"
    sdktypes "github.com/sdkwork/sdkwork-web-app-sdk/types"
...
func NewSiteApi(client *sdkhttp.Client) *SiteApi {
    return &SiteApi{client: client}
}
...
// 创建站点
func (a *SiteApi) SitesCreate(body sdktypes.CreateSiteRequest, idempotencyKey string) (sdktypes.SitesCreateResponse201, error) {
    headers := BuildRequestHeaders(
        map[string]ParameterSpec{"Idempotency-Key": ParameterSpec{Value: idempotencyKey, Style: "simple", Explode: false},},
        map[string]ParameterSpec{},
    )
    raw, err := a.client.Post(AppApiPath("/sites"), body, nil, headers, "application/json")
    if err != nil {
...
// 删除站点
func (a *SiteApi) SitesDelete(siteId string) (struct{}, error) {
    raw, err := a.client.Delete(AppApiPath(fmt.Sprintf("/sites/%s", SerializePathParameter(siteId, PathParameterSpec{Name: "siteId", Style: "simple", Explode: false}))), nil, nil)
    if err != nil {
        var zero struct{}
        return zero, err
    }
