...
public class SiteApi {
    ...
    public SiteApi(HttpClient client) {
        this.client = client;
    }
    ...
    /** 创建站点 */
    public SitesCreateResponse201 sitesCreate(CreateSiteRequest body, String idempotencyKey) throws Exception {
        Map<String, String> requestHeaders = buildRequestHeaders(
                Map.of("Idempotency-Key", new HeaderParameterSpec(idempotencyKey, "simple", false, null)),
                Map.of()
        );
        Object raw = client.post(ApiPaths.appPath("/sites"), body, null, requestHeaders, "application/json");
    ...
    /** 删除站点 */
    public Void sitesDelete(String siteId) throws Exception {
        client.delete(ApiPaths.appPath("/sites/" + serializePathParameter(siteId, new PathParameterSpec("siteId", "simple", false)) + ""));
        return null;
    }
