...
class ApplicationSourceVersionApi:
    """application_source_version application_source_version API client."""

    def __init__(self, client: HttpClient):
        self._client = client
        self.applications = ApplicationSourceVersionApplicationsApi(client)


class ApplicationSourceVersionApplicationsApi:
    """application_source_version application_source_version.applications API client."""

    def __init__(self, client: HttpClient):
        self._client = client
        self.source_versions = ApplicationSourceVersionApplicationsSourceVersionsApi(client)


class ApplicationSourceVersionApplicationsSourceVersionsApi:
    """application_source_version application_source_version.applications.source_versions API client."""
    ...
    def create(self, application_id: str, body: CreateApplicationSourceVersionRequest, idempotency_key: str) -> ApplicationsSourceVersionsCreateResponse201:
