...
class DomainApi:
    ...
    def list(self, page: Optional[int] = None, page_size: Optional[int] = None) -> DomainsListResponse:
        ...
        return self._client.get(_append_query_string(f"/backend/v3/api/domains", query))

    def create(self, body: CreateManagedDomainRequest, idempotency_key: str) -> DomainsCreateResponse201:
        ...
        return self._client.post(f"/backend/v3/api/domains", json=body, headers=request_headers)

    def delete(self, domain_id: str, idempotency_key: str) -> None:
...
class DomainApplicationBindingApi:
    ...
    def update(self, domain_id: str, body: UpdateDomainApplicationBindingRequest, idempotency_key: str) -> DomainsApplicationBindingUpdateResponse:
        ...
        return self._client.put(f"/backend/v3/api/domains/{serialize_path_parameter(domain_id, {'name': 'domainId', 'style': 'simple', 'explode': False})}/application_binding", json=body, headers=request_headers)
    ...
    def delete(self, domain_id: str, idempotency_key: str) -> None:
        ...
        return self._client.delete(f"/backend/v3/api/domains/{serialize_path_parameter(domain_id, {'name': 'domainId', 'style': 'simple', 'explode': False})}/application_binding", headers=request_headers)
