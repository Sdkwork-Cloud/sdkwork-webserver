...
func NewServerApi(client *sdkhttp.Client) *ServerApi {
    return &ServerApi{client: client}
}

// List managed servers
func (a *ServerApi) ServersList(pageSize *int, cursor *string) (sdktypes.ServersListResponse, error) {
...
func (a *ServerApi) ServersCreate(body sdktypes.CreateServerRequest, idempotencyKey string) (sdktypes.ServersCreateResponse201, error) {
    headers := BuildRequestHeaders(
        map[string]ParameterSpec{"Idempotency-Key": ParameterSpec{Value: idempotencyKey, Style: "simple", Explode: false},},
        map[string]ParameterSpec{},
    )
    raw, err := a.client.Post(BackendApiPath("/servers"), body, nil, headers, "application/json")
    if err != nil {
