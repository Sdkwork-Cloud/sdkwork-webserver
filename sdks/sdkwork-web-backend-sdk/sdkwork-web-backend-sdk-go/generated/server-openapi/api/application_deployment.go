...
func (a *ApplicationDeploymentApi) ApplicationsDeploymentsCreate(applicationId string, body sdktypes.CreateApplicationDeploymentRequest) (sdktypes.ApplicationsDeploymentsCreateResponse201, error) {
    raw, err := a.client.Post(BackendApiPath(fmt.Sprintf("/applications/%s/deployments", SerializePathParameter(applicationId, PathParameterSpec{Name: "applicationId", Style: "simple", Explode: false}))), body, nil, nil, "application/json")
    if err != nil {
