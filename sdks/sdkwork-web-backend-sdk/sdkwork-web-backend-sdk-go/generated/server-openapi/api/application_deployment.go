...
type ApplicationDeploymentApi struct {
    client *sdkhttp.Client
}

func NewApplicationDeploymentApi(client *sdkhttp.Client) *ApplicationDeploymentApi {
    return &ApplicationDeploymentApi{client: client}
}

// List application deployments
func (a *ApplicationDeploymentApi) ApplicationsDeploymentsList(applicationId string, page *int, pageSize *int, status *int) (sdktypes.ApplicationsDeploymentsListResponse, error) {
    ...
    raw, err := a.client.Get(AppendQueryString(BackendApiPath(fmt.Sprintf("/applications/%s/deployments", SerializePathParameter(applicationId, PathParameterSpec{Name: "applicationId", Style: "simple", Explode: false}))), query), nil, nil)
    if err != nil {
...
func (a *ApplicationDeploymentApi) ApplicationsDeploymentsCreate(applicationId string, body sdktypes.CreateApplicationDeploymentRequest, idempotencyKey string) (sdktypes.ApplicationsDeploymentsCreateResponse201, error) {
    headers := BuildRequestHeaders(
        map[string]ParameterSpec{"Idempotency-Key": ParameterSpec{Value: idempotencyKey, Style: "simple", Explode: false},},
        map[string]ParameterSpec{},
    )
    raw, err := a.client.Post(BackendApiPath(fmt.Sprintf("/applications/%s/deployments", SerializePathParameter(applicationId, PathParameterSpec{Name: "applicationId", Style: "simple", Explode: false}))), body, nil, headers, "application/json")
    if err != nil {
...
func (a *ApplicationDeploymentApi) ApplicationsDeploymentsRollback(applicationId string, deploymentId string, idempotencyKey string) (sdktypes.ApplicationsDeploymentsRollbackResponse, error) {
    ...
    raw, err := a.client.Post(BackendApiPath(fmt.Sprintf("/applications/%s/deployments/%s/rollback", SerializePathParameter(applicationId, PathParameterSpec{Name: "applicationId", Style: "simple", Explode: false}), SerializePathParameter(deploymentId, PathParameterSpec{Name: "deploymentId", Style: "simple", Explode: false}))), nil, nil, headers, "")
    if err != nil {
