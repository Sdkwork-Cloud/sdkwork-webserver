...
type ApplicationDomainApi struct {
    client *sdkhttp.Client
}

func NewApplicationDomainApi(client *sdkhttp.Client) *ApplicationDomainApi {
    return &ApplicationDomainApi{client: client}
}

// List application domains
func (a *ApplicationDomainApi) ApplicationsDomainsList(applicationId string, page *int, pageSize *int) (sdktypes.ApplicationsDomainsListResponse, error) {
    query := BuildQueryString([]QueryParameterSpec{
        {Name: "page", Value: func() interface{} { if page == nil { return nil }; return *page }(), Style: "form", Explode: true, AllowReserved: false},
        {Name: "page_size", Value: func() interface{} { if pageSize == nil { return nil }; return *pageSize }(), Style: "form", Explode: true, AllowReserved: false},
    })
    raw, err := a.client.Get(AppendQueryString(BackendApiPath(fmt.Sprintf("/applications/%s/domains", SerializePathParameter(applicationId, PathParameterSpec{Name: "applicationId", Style: "simple", Explode: false}))), query), nil, nil)
    if err != nil {
