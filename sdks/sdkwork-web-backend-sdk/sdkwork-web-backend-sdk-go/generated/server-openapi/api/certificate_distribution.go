...
type CertificateDistributionApi struct {
    client *sdkhttp.Client
}

func NewCertificateDistributionApi(client *sdkhttp.Client) *CertificateDistributionApi {
    return &CertificateDistributionApi{client: client}
}

// List certificate manifest convergence by server
func (a *CertificateDistributionApi) CertificatesDistributionList(page *int, pageSize *int) (sdktypes.CertificatesDistributionListResponse, error) {
    query := BuildQueryString([]QueryParameterSpec{
        {Name: "page", Value: func() interface{} { if page == nil { return nil }; return *page }(), Style: "form", Explode: true, AllowReserved: false},
        {Name: "page_size", Value: func() interface{} { if pageSize == nil { return nil }; return *pageSize }(), Style: "form", Explode: true, AllowReserved: false},
    })
    raw, err := a.client.Get(AppendQueryString(BackendApiPath("/certificate_distribution"), query), nil, nil)
    if err != nil {
        var zero sdktypes.CertificatesDistributionListResponse
        return zero, err
    }
    return decodeResult[sdktypes.CertificatesDistributionListResponse](raw)
}
