...
namespace SDKWork.Web.BackendSdk.Api
{
    public class ApplicationDeploymentApi
    {
        ...
        public ApplicationDeploymentApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<SDKWork.Web.BackendSdk.Models.ApplicationsDeploymentsListResponse?> ApplicationsDeploymentsListAsync(string applicationId, int? page = null, int? pageSize = null, int? status = null)
        {
            ...
            return await _client.GetAsync<SDKWork.Web.BackendSdk.Models.ApplicationsDeploymentsListResponse>(ApiPaths.AppendQueryString(ApiPaths.BackendPath($"/applications/{SerializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false))}/deployments"), queryString));
        }

        /// <summary>
        /// Deploy an application
        /// </summary>
        public async Task<SDKWork.Web.BackendSdk.Models.ApplicationsDeploymentsCreateResponse201?> ApplicationsDeploymentsCreateAsync(string applicationId, SDKWork.Web.BackendSdk.Models.CreateApplicationDeploymentRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<SDKWork.Web.BackendSdk.Models.ApplicationsDeploymentsCreateResponse201>(ApiPaths.BackendPath($"/applications/{SerializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false))}/deployments"), body, null, requestHeaders, "application/json");
        }
        ...
        public async Task<SDKWork.Web.BackendSdk.Models.ApplicationsDeploymentsRollbackResponse?> ApplicationsDeploymentsRollbackAsync(string applicationId, string deploymentId, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<SDKWork.Web.BackendSdk.Models.ApplicationsDeploymentsRollbackResponse>(ApiPaths.BackendPath($"/applications/{SerializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false))}/deployments/{SerializePathParameter(deploymentId, new PathParameterSpec("deploymentId", "simple", false))}/rollback"), null, null, requestHeaders);
        }
