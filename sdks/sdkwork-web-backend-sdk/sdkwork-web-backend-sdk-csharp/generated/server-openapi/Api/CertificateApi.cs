...
namespace SDKWork.Web.BackendSdk.Api
{
    public class CertificateApi
    {
        ...
        public CertificateApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<SDKWork.Web.BackendSdk.Models.CertificatesCreateResponse201?> CertificatesCreateAsync(SDKWork.Web.BackendSdk.Models.CreateCertificateRequest body)
        {
            return await _client.PostAsync<SDKWork.Web.BackendSdk.Models.CertificatesCreateResponse201>(ApiPaths.BackendPath("/certificates"), body, null, null, "application/json");
        }

        /// <summary>
        /// Update certificate automatic renewal policy
        /// </summary>
        public async Task<SDKWork.Web.BackendSdk.Models.CertificatesUpdateResponse?> CertificatesUpdateAsync(string certificateId, SDKWork.Web.BackendSdk.Models.UpdateCertificateRequest body)
        {
            return await _client.PutAsync<SDKWork.Web.BackendSdk.Models.CertificatesUpdateResponse>(ApiPaths.BackendPath($"/certificates/{SerializePathParameter(certificateId, new PathParameterSpec("certificateId", "simple", false))}"), body, null, null, "application/json");
        }

        /// <summary>
        /// Renew a canonical certificate now
        /// </summary>
        public async Task<SDKWork.Web.BackendSdk.Models.CertificatesRenewResponse?> CertificatesRenewAsync(string certificateId)
        {
            return await _client.PostAsync<SDKWork.Web.BackendSdk.Models.CertificatesRenewResponse>(ApiPaths.BackendPath($"/certificates/{SerializePathParameter(certificateId, new PathParameterSpec("certificateId", "simple", false))}/renew"), null);
        }
