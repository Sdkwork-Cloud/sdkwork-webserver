...
namespace SDKWork.Web.BackendSdk.Api
{
    public class ServerApi
    {
        ...
        /// </summary>
        public async Task<SDKWork.Web.BackendSdk.Models.ServersCreateResponse201?> ServersCreateAsync(SDKWork.Web.BackendSdk.Models.CreateServerRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<SDKWork.Web.BackendSdk.Models.ServersCreateResponse201>(ApiPaths.BackendPath("/servers"), body, null, requestHeaders, "application/json");
        }
