...
namespace SDKWork.Web.BackendSdk.Api
{
    public class ApplicationDomainApi
    {
        ...
        public ApplicationDomainApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<SDKWork.Web.BackendSdk.Models.ApplicationsDomainsListResponse?> ApplicationsDomainsListAsync(string applicationId, int? page = null, int? pageSize = null)
        {
            ...
            return await _client.GetAsync<SDKWork.Web.BackendSdk.Models.ApplicationsDomainsListResponse>(ApiPaths.AppendQueryString(ApiPaths.BackendPath($"/applications/{SerializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false))}/domains"), queryString));
        }

        /// <summary>
        /// Bind a public domain to an application
        /// </summary>
        public async Task<SDKWork.Web.BackendSdk.Models.ApplicationsDomainsCreateResponse201?> ApplicationsDomainsCreateAsync(string applicationId, SDKWork.Web.BackendSdk.Models.CreateApplicationDomainRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<SDKWork.Web.BackendSdk.Models.ApplicationsDomainsCreateResponse201>(ApiPaths.BackendPath($"/applications/{SerializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false))}/domains"), body, null, requestHeaders, "application/json");
        }

        /// <summary>
        /// Unbind an application public domain
        /// </summary>
        public async Task ApplicationsDomainsDeleteAsync(string applicationId, string domainId, string idempotencyKey)
        {
            var requestHeaders = BuildRequestHeaders(
                new Dictionary<string, HeaderParameterSpec>
                {
            ...
            await _client.DeleteAsync<object>(ApiPaths.BackendPath($"/applications/{SerializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false))}/domains/{SerializePathParameter(domainId, new PathParameterSpec("domainId", "simple", false))}"), null, requestHeaders);
        }
        ...
        public async Task<SDKWork.Web.BackendSdk.Models.ApplicationsDomainsVerifyResponse?> ApplicationsDomainsVerifyAsync(string applicationId, string domainId, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<SDKWork.Web.BackendSdk.Models.ApplicationsDomainsVerifyResponse>(ApiPaths.BackendPath($"/applications/{SerializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false))}/domains/{SerializePathParameter(domainId, new PathParameterSpec("domainId", "simple", false))}/verify"), null, null, requestHeaders);
        }
