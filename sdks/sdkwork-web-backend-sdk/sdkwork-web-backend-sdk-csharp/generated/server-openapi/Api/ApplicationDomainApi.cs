...
namespace SDKWork.Web.BackendSdk.Api
{
    public class ApplicationDomainApi
    {
        ...
        /// </summary>
        public async Task<SDKWork.Web.BackendSdk.Models.ApplicationsDomainsCreateResponse201?> ApplicationsDomainsCreateAsync(string applicationId, SDKWork.Web.BackendSdk.Models.CreateApplicationDomainRequest body)
        {
            return await _client.PostAsync<SDKWork.Web.BackendSdk.Models.ApplicationsDomainsCreateResponse201>(ApiPaths.BackendPath($"/applications/{SerializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false))}/domains"), body, null, null, "application/json");
        }
