...
namespace SDKWork.Web.BackendSdk.Api
{
    public class ApplicationSourceVersionApi
    {
        ...
        public ApplicationSourceVersionApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<SDKWork.Web.BackendSdk.Models.ApplicationsSourceVersionsCreateResponse201?> ApplicationsSourceVersionsCreateAsync(string applicationId, SDKWork.Web.BackendSdk.Models.CreateApplicationSourceVersionRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<SDKWork.Web.BackendSdk.Models.ApplicationsSourceVersionsCreateResponse201>(ApiPaths.BackendPath($"/applications/{SerializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false))}/source_versions"), body, null, requestHeaders, "application/json");
        }
        ...
        /// </summary>
        public async Task<SDKWork.Web.BackendSdk.Models.ApplicationsSourceVersionsRetrieveResponse?> ApplicationsSourceVersionsRetrieveAsync(string applicationId, string sourceVersionId)
        {
            return await _client.GetAsync<SDKWork.Web.BackendSdk.Models.ApplicationsSourceVersionsRetrieveResponse>(ApiPaths.BackendPath($"/applications/{SerializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false))}/source_versions/{SerializePathParameter(sourceVersionId, new PathParameterSpec("sourceVersionId", "simple", false))}"));
        }
