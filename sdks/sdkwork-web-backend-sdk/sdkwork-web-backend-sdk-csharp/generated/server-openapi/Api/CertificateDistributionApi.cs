...
namespace SDKWork.Web.BackendSdk.Api
{
    public class CertificateDistributionApi
    {
        ...
        public CertificateDistributionApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<SDKWork.Web.BackendSdk.Models.CertificatesDistributionListResponse?> CertificatesDistributionListAsync(int? page = null, int? pageSize = null)
        {
            ...
            return await _client.GetAsync<SDKWork.Web.BackendSdk.Models.CertificatesDistributionListResponse>(ApiPaths.AppendQueryString(ApiPaths.BackendPath("/certificate_distribution"), queryString));
        }
