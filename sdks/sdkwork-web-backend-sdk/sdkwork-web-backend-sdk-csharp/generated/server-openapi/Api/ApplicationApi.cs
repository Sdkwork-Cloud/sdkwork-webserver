...
namespace SDKWork.Web.BackendSdk.Api
{
    public class ApplicationApi
    {
        ...
        public ApplicationApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<SDKWork.Web.BackendSdk.Models.ApplicationsListResponse?> ApplicationsListAsync(int? page = null, int? pageSize = null, string? applicationType = null, int? siteType = null, int? status = null, string? keyword = null)
        {
            ...
            return await _client.GetAsync<SDKWork.Web.BackendSdk.Models.ApplicationsListResponse>(ApiPaths.AppendQueryString(ApiPaths.BackendPath("/applications"), queryString));
        }
        ...
        /// </summary>
        public async Task<SDKWork.Web.BackendSdk.Models.ApplicationsRetrieveResponse?> ApplicationsRetrieveAsync(string applicationId)
        {
            return await _client.GetAsync<SDKWork.Web.BackendSdk.Models.ApplicationsRetrieveResponse>(ApiPaths.BackendPath($"/applications/{SerializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false))}"));
        }
