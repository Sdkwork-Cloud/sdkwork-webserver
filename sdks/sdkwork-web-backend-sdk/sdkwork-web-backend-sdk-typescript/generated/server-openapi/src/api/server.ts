...
/** Register a managed server */
  async create(body: CreateServerRequest, params: ServerCreateParams, requestOptions?: ApiRequestOptions): Promise<CreateServerResponse> {
...
export function createServerApi(client: HttpClient): ServerApi {
  return new ServerApi(client);
}
