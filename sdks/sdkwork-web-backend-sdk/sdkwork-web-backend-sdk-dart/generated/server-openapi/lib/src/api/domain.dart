...
class DomainApi {
  ...
  Future<DomainsListResponse?> domainsList([int? page, int? pageSize]) async {
    ...
    final response = await _client.get(ApiPaths.appendQueryString(ApiPaths.backendPath('/domains'), query));
    return (() {
      final map = sdkworkResponseAsMap(response);
  ...
  Future<DomainsCreateResponse201?> domainsCreate(CreateManagedDomainRequest body, String idempotencyKey) async {
    final requestHeaders = buildRequestHeaders(
      <String, HeaderParameterSpec>{
        'Idempotency-Key': HeaderParameterSpec(idempotencyKey, 'simple', false, null),
      },
    ...
    final payload = body.toJson();
    final response = await _client.post(ApiPaths.backendPath('/domains'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : DomainsCreateResponse201.fromJson(map);
    })();
  }

  /// Delete an unbound tenant custom domain asset
  Future<void> domainsDelete(String domainId, String idempotencyKey) async {
    final requestHeaders = buildRequestHeaders(
      <String, HeaderParameterSpec>{
        'Idempotency-Key': HeaderParameterSpec(idempotencyKey, 'simple', false, null),
      },
  ...
  Future<DomainsVerifyResponse?> domainsVerify(String domainId, String idempotencyKey) async {
    ...
    final response = await _client.post(ApiPaths.backendPath('/domains/${serializePathParameter(domainId, const PathParameterSpec('domainId', 'simple', false))}/verify'), headers: requestHeaders);
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : DomainsVerifyResponse.fromJson(map);
    })();
  }

  /// Bind a tenant custom domain to an application
  Future<DomainsApplicationBindingUpdateResponse?> domainsApplicationBindingUpdate(String domainId, UpdateDomainApplicationBindingRequest body, String idempotencyKey) async {
    final requestHeaders = buildRequestHeaders(
      <String, HeaderParameterSpec>{
        'Idempotency-Key': HeaderParameterSpec(idempotencyKey, 'simple', false, null),
      },
    ...
    final payload = body.toJson();
    final response = await _client.put(ApiPaths.backendPath('/domains/${serializePathParameter(domainId, const PathParameterSpec('domainId', 'simple', false))}/application_binding'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
      return map == null ? null : DomainsApplicationBindingUpdateResponse.fromJson(map);
    })();
  }

  /// Unbind a tenant custom domain from its application
  Future<void> domainsApplicationBindingDelete(String domainId, String idempotencyKey) async {
    final requestHeaders = buildRequestHeaders(
      <String, HeaderParameterSpec>{
        'Idempotency-Key': HeaderParameterSpec(idempotencyKey, 'simple', false, null),
      },
    ...
    await _client.delete(ApiPaths.backendPath('/domains/${serializePathParameter(domainId, const PathParameterSpec('domainId', 'simple', false))}/application_binding'), headers: requestHeaders);
  }
}
