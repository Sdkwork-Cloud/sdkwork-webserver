...
class ApplicationDomainApi(private val client: HttpClient) {
    ...
    suspend fun applicationsDomainsList(applicationId: String, page: Int? = null, pageSize: Int? = null): ApplicationsDomainsListResponse? {
        ...
        val raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/applications/${serializePathParameter(applicationId, PathParameterSpec("applicationId", "simple", false))}/domains"), query))
