...
class ApplicationDeploymentApi(private val client: HttpClient) {
    ...
    suspend fun applicationsDeploymentsCreate(applicationId: String, body: CreateApplicationDeploymentRequest): ApplicationsDeploymentsCreateResponse201? {
        val raw = client.post(ApiPaths.backendPath("/applications/${serializePathParameter(applicationId, PathParameterSpec("applicationId", "simple", false))}/deployments"), body, null, null, "application/json")
