...
class ApplicationSourceVersionApi(private val client: HttpClient) {
    ...
    suspend fun applicationsSourceVersionsCreate(applicationId: String, body: CreateApplicationSourceVersionRequest, idempotencyKey: String): ApplicationsSourceVersionsCreateResponse201? {
        ...
        val raw = client.post(ApiPaths.backendPath("/applications/${serializePathParameter(applicationId, PathParameterSpec("applicationId", "simple", false))}/source_versions"), body, null, requestHeaders, "application/json")
    ...
    suspend fun applicationsSourceVersionsRetrieve(applicationId: String, sourceVersionId: String): ApplicationsSourceVersionsRetrieveResponse? {
        val raw = client.get(ApiPaths.backendPath("/applications/${serializePathParameter(applicationId, PathParameterSpec("applicationId", "simple", false))}/source_versions/${serializePathParameter(sourceVersionId, PathParameterSpec("sourceVersionId", "simple", false))}"))
