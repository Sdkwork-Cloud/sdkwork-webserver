...
public class ApplicationSourceVersionApi {
    ...
    public func applicationsSourceVersionsCreate(applicationId: String, body: CreateApplicationSourceVersionRequest, idempotencyKey: String) async throws -> ApplicationsSourceVersionsCreateResponse201? {
