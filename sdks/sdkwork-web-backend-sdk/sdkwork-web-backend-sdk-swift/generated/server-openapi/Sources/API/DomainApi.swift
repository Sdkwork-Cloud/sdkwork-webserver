...
public class DomainApi {
    ...
    public func domainsList(page: Int? = nil, pageSize: Int? = nil) async throws -> DomainsListResponse? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/domains"), query), responseType: DomainsListResponse.self)
    }

    /// Register a tenant custom domain asset
    public func domainsCreate(body: CreateManagedDomainRequest, idempotencyKey: String) async throws -> DomainsCreateResponse201? {
        let requestHeaders = buildRequestHeaders(
            [
                "Idempotency-Key": HeaderParameterSpec(value: idempotencyKey, style: "simple", explode: false, contentType: nil),
            ],
        ...
        return try await client.post(ApiPaths.backendPath("/domains"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: DomainsCreateResponse201.self)
    }

    /// Delete an unbound tenant custom domain asset
    public func domainsDelete(domainId: String, idempotencyKey: String) async throws -> Void {
        let requestHeaders = buildRequestHeaders(
            [
                "Idempotency-Key": HeaderParameterSpec(value: idempotencyKey, style: "simple", explode: false, contentType: nil),
            ],
    ...
    public func domainsVerify(domainId: String, idempotencyKey: String) async throws -> DomainsVerifyResponse? {
        ...
        return try await client.post(ApiPaths.backendPath("/domains/\(serializePathParameter(domainId, PathParameterSpec(name: "domainId", style: "simple", explode: false)))/verify"), body: nil, params: nil, headers: requestHeaders, responseType: DomainsVerifyResponse.self)
    }

    /// Bind a tenant custom domain to an application
    public func domainsApplicationBindingUpdate(domainId: String, body: UpdateDomainApplicationBindingRequest, idempotencyKey: String) async throws -> DomainsApplicationBindingUpdateResponse? {
        let requestHeaders = buildRequestHeaders(
            [
                "Idempotency-Key": HeaderParameterSpec(value: idempotencyKey, style: "simple", explode: false, contentType: nil),
            ],
        ...
        return try await client.put(ApiPaths.backendPath("/domains/\(serializePathParameter(domainId, PathParameterSpec(name: "domainId", style: "simple", explode: false)))/application_binding"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: DomainsApplicationBindingUpdateResponse.self)
    }

    /// Unbind a tenant custom domain from its application
    public func domainsApplicationBindingDelete(domainId: String, idempotencyKey: String) async throws -> Void {
        let requestHeaders = buildRequestHeaders(
            [
                "Idempotency-Key": HeaderParameterSpec(value: idempotencyKey, style: "simple", explode: false, contentType: nil),
            ],
        ...
        _ = try await client.delete(ApiPaths.backendPath("/domains/\(serializePathParameter(domainId, PathParameterSpec(name: "domainId", style: "simple", explode: false)))/application_binding"), params: nil, headers: requestHeaders)
    }
