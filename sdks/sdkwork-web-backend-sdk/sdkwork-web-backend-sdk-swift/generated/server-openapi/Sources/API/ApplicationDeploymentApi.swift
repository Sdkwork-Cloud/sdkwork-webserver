...
public class ApplicationDeploymentApi {
    ...
    public func applicationsDeploymentsCreate(applicationId: String, body: CreateApplicationDeploymentRequest) async throws -> ApplicationsDeploymentsCreateResponse201? {
