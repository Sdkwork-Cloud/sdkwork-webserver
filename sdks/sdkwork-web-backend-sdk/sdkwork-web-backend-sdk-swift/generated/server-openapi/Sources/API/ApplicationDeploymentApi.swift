...
public class ApplicationDeploymentApi {
    ...
    public func applicationsDeploymentsCreate(applicationId: String, body: CreateApplicationDeploymentRequest, idempotencyKey: String) async throws -> ApplicationsDeploymentsCreateResponse201? {
