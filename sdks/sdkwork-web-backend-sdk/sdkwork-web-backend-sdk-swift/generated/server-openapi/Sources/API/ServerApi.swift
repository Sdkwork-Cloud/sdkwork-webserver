...
public class ServerApi {
    ...
    public func serversCreate(body: CreateServerRequest, idempotencyKey: String) async throws -> ServersCreateResponse201? {
        ...
        return try await client.post(ApiPaths.backendPath("/servers"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: ServersCreateResponse201.self)
    }
