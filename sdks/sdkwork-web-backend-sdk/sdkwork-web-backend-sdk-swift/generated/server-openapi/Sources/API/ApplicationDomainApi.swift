...
public class ApplicationDomainApi {
    ...
    public func applicationsDomainsList(applicationId: String, page: Int? = nil, pageSize: Int? = nil) async throws -> ApplicationsDomainsListResponse? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/applications/\(serializePathParameter(applicationId, PathParameterSpec(name: "applicationId", style: "simple", explode: false)))/domains"), query), responseType: ApplicationsDomainsListResponse.self)
    }

    /// Bind a public domain to an application
    public func applicationsDomainsCreate(applicationId: String, body: CreateApplicationDomainRequest, idempotencyKey: String) async throws -> ApplicationsDomainsCreateResponse201? {
        ...
        return try await client.post(ApiPaths.backendPath("/applications/\(serializePathParameter(applicationId, PathParameterSpec(name: "applicationId", style: "simple", explode: false)))/domains"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: ApplicationsDomainsCreateResponse201.self)
    }

    /// Unbind an application public domain
    public func applicationsDomainsDelete(applicationId: String, domainId: String, idempotencyKey: String) async throws -> Void {
        let requestHeaders = buildRequestHeaders(
            [
                "Idempotency-Key": HeaderParameterSpec(value: idempotencyKey, style: "simple", explode: false, contentType: nil),
            ],
