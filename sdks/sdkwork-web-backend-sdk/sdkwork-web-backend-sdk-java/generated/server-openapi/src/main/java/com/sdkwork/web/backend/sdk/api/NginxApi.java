...
public class NginxApi {
    ...
    public ConfigsCreateResponse201 configsCreate(CreateNginxConfigRequest body, String idempotencyKey) throws Exception {
        Map<String, String> requestHeaders = buildRequestHeaders(
                Map.of("Idempotency-Key", new HeaderParameterSpec(idempotencyKey, "simple", false, null)),
                Map.of()
        );
        Object raw = client.post(ApiPaths.backendPath("/nginx/configs"), body, null, requestHeaders, "application/json");
    ...
    public ConfigsUpdateResponse configsUpdate(String configId, UpdateNginxConfigRequest body, String idempotencyKey) throws Exception {
        Map<String, String> requestHeaders = buildRequestHeaders(
                Map.of("Idempotency-Key", new HeaderParameterSpec(idempotencyKey, "simple", false, null)),
                Map.of()
        );
        Object raw = client.put(ApiPaths.backendPath("/nginx/etc/" + serializePathParameter(configId, new PathParameterSpec("configId", "simple", false)) + ""), body, null, requestHeaders, "application/json");
    ...
    public ConfigsDeployResponse configsDeploy(String configId, String idempotencyKey) throws Exception {
        Map<String, String> requestHeaders = buildRequestHeaders(
                Map.of("Idempotency-Key", new HeaderParameterSpec(idempotencyKey, "simple", false, null)),
                Map.of()
        );
        Object raw = client.post(ApiPaths.backendPath("/nginx/etc/" + serializePathParameter(configId, new PathParameterSpec("configId", "simple", false)) + "/deploy"), null, null, requestHeaders);
        return client.convertValue(raw, new TypeReference<ConfigsDeployResponse>() {});
    }

    /** Reload Nginx */
    public ReloadResponse reload(String idempotencyKey) throws Exception {
        Map<String, String> requestHeaders = buildRequestHeaders(
                Map.of("Idempotency-Key", new HeaderParameterSpec(idempotencyKey, "simple", false, null)),
                Map.of()
        );
        Object raw = client.post(ApiPaths.backendPath("/nginx/reload"), null, null, requestHeaders);
