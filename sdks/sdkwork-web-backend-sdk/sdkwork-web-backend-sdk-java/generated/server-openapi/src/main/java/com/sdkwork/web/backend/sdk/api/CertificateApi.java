...
public class CertificateApi {
    ...
    public CertificateApi(HttpClient client) {
        this.client = client;
    }
    ...
    public CertificatesCreateResponse201 certificatesCreate(CreateCertificateRequest body) throws Exception {
        Object raw = client.post(ApiPaths.backendPath("/certificates"), body, null, null, "application/json");
    ...
    public CertificatesUpdateResponse certificatesUpdate(String certificateId, UpdateCertificateRequest body) throws Exception {
        Object raw = client.put(ApiPaths.backendPath("/certificates/" + serializePathParameter(certificateId, new PathParameterSpec("certificateId", "simple", false)) + ""), body, null, null, "application/json");
        return client.convertValue(raw, new TypeReference<CertificatesUpdateResponse>() {});
    }

    /** Renew a canonical certificate now */
    public CertificatesRenewResponse certificatesRenew(String certificateId) throws Exception {
        Object raw = client.post(ApiPaths.backendPath("/certificates/" + serializePathParameter(certificateId, new PathParameterSpec("certificateId", "simple", false)) + "/renew"), null);
