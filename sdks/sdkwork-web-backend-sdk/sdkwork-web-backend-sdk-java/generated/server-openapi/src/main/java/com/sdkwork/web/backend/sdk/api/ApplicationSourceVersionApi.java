...
public class ApplicationSourceVersionApi {
    ...
    public ApplicationSourceVersionApi(HttpClient client) {
        this.client = client;
    }
    ...
    public ApplicationsSourceVersionsCreateResponse201 applicationsSourceVersionsCreate(String applicationId, CreateApplicationSourceVersionRequest body, String idempotencyKey) throws Exception {
        Map<String, String> requestHeaders = buildRequestHeaders(
                Map.of("Idempotency-Key", new HeaderParameterSpec(idempotencyKey, "simple", false, null)),
                Map.of()
        );
        Object raw = client.post(ApiPaths.backendPath("/applications/" + serializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false)) + "/source_versions"), body, null, requestHeaders, "application/json");
    ...
    public ApplicationsSourceVersionsRetrieveResponse applicationsSourceVersionsRetrieve(String applicationId, String sourceVersionId) throws Exception {
        Object raw = client.get(ApiPaths.backendPath("/applications/" + serializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false)) + "/source_versions/" + serializePathParameter(sourceVersionId, new PathParameterSpec("sourceVersionId", "simple", false)) + ""));
