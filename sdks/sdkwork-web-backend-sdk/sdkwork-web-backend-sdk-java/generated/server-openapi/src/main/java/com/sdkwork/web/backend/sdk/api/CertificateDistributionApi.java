...
public class CertificateDistributionApi {
    ...
    public CertificateDistributionApi(HttpClient client) {
        this.client = client;
    }

    /** List certificate manifest convergence by server */
    public CertificatesDistributionListResponse certificatesDistributionList(Integer page, Integer pageSize) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("page", page, "form", true, false, null),
            new QueryParameterSpec("page_size", pageSize, "form", true, false, null)
        ));
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/certificate_distribution"), query));
        return client.convertValue(raw, new TypeReference<CertificatesDistributionListResponse>() {});
    }
