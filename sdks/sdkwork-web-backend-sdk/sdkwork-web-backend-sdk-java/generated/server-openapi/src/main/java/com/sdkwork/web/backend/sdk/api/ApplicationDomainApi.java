...
public class ApplicationDomainApi {
    ...
    public ApplicationDomainApi(HttpClient client) {
        this.client = client;
    }
    ...
    public ApplicationsDomainsListResponse applicationsDomainsList(String applicationId, Integer page, Integer pageSize) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/applications/" + serializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false)) + "/domains"), query));
