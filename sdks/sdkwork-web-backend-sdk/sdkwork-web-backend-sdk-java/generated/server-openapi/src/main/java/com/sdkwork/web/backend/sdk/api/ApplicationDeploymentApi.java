...
public class ApplicationDeploymentApi {
    ...
    public ApplicationDeploymentApi(HttpClient client) {
        this.client = client;
    }
    ...
    public ApplicationsDeploymentsCreateResponse201 applicationsDeploymentsCreate(String applicationId, CreateApplicationDeploymentRequest body, String idempotencyKey) throws Exception {
        Map<String, String> requestHeaders = buildRequestHeaders(
                Map.of("Idempotency-Key", new HeaderParameterSpec(idempotencyKey, "simple", false, null)),
                Map.of()
        );
        Object raw = client.post(ApiPaths.backendPath("/applications/" + serializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false)) + "/deployments"), body, null, requestHeaders, "application/json");
    ...
    public ApplicationsDeploymentsRollbackResponse applicationsDeploymentsRollback(String applicationId, String deploymentId, String idempotencyKey) throws Exception {
        ...
        Object raw = client.post(ApiPaths.backendPath("/applications/" + serializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false)) + "/deployments/" + serializePathParameter(deploymentId, new PathParameterSpec("deploymentId", "simple", false)) + "/rollback"), null, null, requestHeaders);
