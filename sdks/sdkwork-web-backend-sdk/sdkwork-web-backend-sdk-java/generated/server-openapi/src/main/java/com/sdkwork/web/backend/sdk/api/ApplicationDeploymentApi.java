...
public class ApplicationDeploymentApi {
    ...
    public ApplicationsDeploymentsCreateResponse201 applicationsDeploymentsCreate(String applicationId, CreateApplicationDeploymentRequest body) throws Exception {
        Object raw = client.post(ApiPaths.backendPath("/applications/" + serializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false)) + "/deployments"), body, null, null, "application/json");
