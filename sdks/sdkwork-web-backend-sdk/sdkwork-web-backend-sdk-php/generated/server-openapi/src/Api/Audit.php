...
{
    /** List audit logs */
    public function logsList(?int $page = null, ?int $pageSize = null, ?string $cursor = null, ?string $targetType = null, ?string $action = null, ?string $operatorId = null, ?string $startDate = null, ?string $endDate = null): ?AuditLogsListResponse
    {
