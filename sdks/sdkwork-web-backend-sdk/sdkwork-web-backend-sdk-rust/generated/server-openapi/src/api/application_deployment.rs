...
#[derive(Clone)]
pub struct ApplicationDeploymentApi {
    client: Arc<SdkworkHttpClient>,
}

impl ApplicationDeploymentApi {
    ...
    pub async fn applications_deployments_create(&self, application_id: &str, body: &CreateApplicationDeploymentRequest) -> Result<ApplicationDeploymentResponse, SdkworkError> {
