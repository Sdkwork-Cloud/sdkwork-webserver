...
use crate::models::{
    ApplicationSourceVersionResponse, CreateApplicationSourceVersionRequest,
...
impl ApplicationSourceVersionApi {
    ...
    pub async fn applications_source_versions_list(
        &self,
        application_id: &str,
    ...
    pub async fn applications_source_versions_create(
        &self,
        application_id: &str,
        body: &CreateApplicationSourceVersionRequest,
        idempotency_key: &str,
    ) -> Result<ApplicationSourceVersionResponse, SdkworkError> {
    ...
    pub async fn applications_source_versions_git_import_create(
        &self,
        application_id: &str,
        body: &ImportApplicationGitSourceVersionRequest,
        idempotency_key: &str,
    ) -> Result<ApplicationSourceVersionResponse, SdkworkError> {
        let path = backend_path(&format!(
            "/applications/{}/source_versions/git_import",
            serialize_path_parameter(
                application_id,
                PathParameterSpec::new("applicationId", "simple", false)
            )
    ...
    pub async fn applications_source_versions_retrieve(
        &self,
        application_id: &str,
        ...
        let path = backend_path(&format!(
            ...
            serialize_path_parameter(
                source_version_id,
                PathParameterSpec::new("sourceVersionId", "simple", false)
            )
        ));
        self.client.get(&path, None, None).await
    }
