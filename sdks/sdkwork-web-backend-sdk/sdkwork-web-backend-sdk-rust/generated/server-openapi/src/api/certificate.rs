...
impl CertificateApi {
    ...
    pub async fn certificates_create(&self, body: &CreateCertificateRequest) -> Result<CertificateResponse, SdkworkError> {
        let path = backend_path(&"/certificates".to_string());
        self.client.post(&path, Some(body), None, None, Some("application/json")).await
    }

    /// Update certificate automatic renewal policy
    pub async fn certificates_update(&self, certificate_id: &str, body: &UpdateCertificateRequest) -> Result<CertificateResponse, SdkworkError> {
    ...
    pub async fn certificates_renew(&self, certificate_id: &str) -> Result<CertificateResponse, SdkworkError> {
