...
impl NginxApi {
    ...
    pub async fn configs_create(&self, body: &CreateNginxConfigRequest, idempotency_key: &str) -> Result<NginxConfigResponse, SdkworkError> {
    ...
    pub async fn configs_update(&self, config_id: &str, body: &UpdateNginxConfigRequest, idempotency_key: &str) -> Result<NginxConfigResponse, SdkworkError> {
        let path = backend_path(&format!("/nginx/etc/{}", serialize_path_parameter(config_id, PathParameterSpec::new("configId", "simple", false))));
        let headers = build_request_headers(
            &[
                ("Idempotency-Key", HeaderParameterSpec::new(idempotency_key, "simple", false, None)),
    ...
    pub async fn configs_deploy(&self, config_id: &str, idempotency_key: &str) -> Result<NginxDeployResponse, SdkworkError> {
