...
impl ApplicationDomainApi {
    ...
    pub async fn applications_domains_create(&self, application_id: &str, body: &CreateApplicationDomainRequest) -> Result<ApplicationDomainResponse, SdkworkError> {
