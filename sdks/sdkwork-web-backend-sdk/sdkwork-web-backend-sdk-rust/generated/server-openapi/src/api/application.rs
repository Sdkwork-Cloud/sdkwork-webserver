...
impl ApplicationApi {
    ...
    pub async fn applications_list(&self, page: Option<i64>, page_size: Option<i64>, application_type: Option<&str>, site_type: Option<i64>, status: Option<i64>, keyword: Option<&str>) -> Result<serde_json::Value, SdkworkError> {
        ...
        let path = append_query_string(backend_path(&"/applications".to_string()), &query);
        self.client.get(&path, None, None).await
    }

    /// Create a managed application
    pub async fn applications_create(&self, body: &CreateApplicationRequest) -> Result<ApplicationResponse, SdkworkError> {
    ...
    pub async fn applications_update(&self, application_id: &str, body: &UpdateApplicationRequest) -> Result<ApplicationResponse, SdkworkError> {
        let path = backend_path(&format!("/applications/{}", serialize_path_parameter(application_id, PathParameterSpec::new("applicationId", "simple", false))));
        self.client.patch(&path, Some(body), None, None, Some("application/json")).await
    }

    /// Delete a managed application
    pub async fn applications_delete(&self, application_id: &str) -> Result<(), SdkworkError> {
        let path = backend_path(&format!("/applications/{}", serialize_path_parameter(application_id, PathParameterSpec::new("applicationId", "simple", false))));
        self.client.delete(&path, None, None).await
    }

    /// Activate a managed application
    pub async fn applications_activate(&self, application_id: &str) -> Result<ApplicationResponse, SdkworkError> {
