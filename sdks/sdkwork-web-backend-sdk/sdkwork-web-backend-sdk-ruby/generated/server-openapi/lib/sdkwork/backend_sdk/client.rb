module Sdkwork
  module BackendSdk
    class SdkworkBackendClient
      attr_reader :http, :application, :application_domain, :certificate, :domain, :application_source_version, :application_deployment, :certificate_distribution, :nginx, :server, :agent, :audit
