...
const packages = [
  ...
  { id: "console-deployments", surface: "app-console", capability: "deployments", deps: { "@sdkwork/webserver-pc-commons": "workspace:*" }, module: [["source-versions", "Source versions", "Immutable Drive-backed application source versions", "web.sites.write"], ["deployments", "Deployments", "Release history and rollback", "web.sites.write"]] },
  ...
  { id: "admin-applications", surface: "backend-admin", capability: "applications", deps: { "@sdkwork/webserver-pc-admin-core": "workspace:*", "@sdkwork/webserver-pc-commons": "workspace:*" }, module: [["applications", "Applications", "Deploy WEB and API applications", "web.sites.read"], ["application-source-versions", "Application source versions", "Immutable Drive-backed application source versions", "web.sites.read"], ["application-domains", "Application domains", "Public domains bound to an application", "web.sites.read"], ["application-deployments", "Application deployments", "Application deployment history", "web.sites.read"]], dataSource: "./data-source.ts", requiredPorts: [{ name: "applicationSourceStorage", export: ".", provider: "@sdkwork/webserver-pc-commons" }] },
  { id: "admin-domains", surface: "backend-admin", capability: "domains", deps: { "@sdkwork/webserver-pc-admin-core": "workspace:*", "@sdkwork/webserver-pc-commons": "workspace:*", "lucide-react": "catalog:", react: "catalog:", "react-router-dom": "^7.15.0" }, module: [["root-domains", "Domain management", "Root-domain Zones, hostnames, deployments, and TLS", "web.sites.read"]], dataSource: "./data-source.ts", extraIndexExports: ['export * from "./RootDomainManagement.tsx";'] },
