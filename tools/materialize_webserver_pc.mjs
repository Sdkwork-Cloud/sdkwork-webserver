...
const packages = [
  ...
  { id: "admin-domains", surface: "backend-admin", capability: "domains", deps: { "@sdkwork/webserver-pc-admin-core": "workspace:*", "@sdkwork/webserver-pc-commons": "workspace:*" }, module: [["managed-domains", "Custom domains", "Tenant domain assets, application bindings, and certificates", "web.sites.read"]], dataSource: "./data-source.ts" },
